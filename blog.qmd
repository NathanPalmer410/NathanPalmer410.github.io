...
You can now use this info to do all sorts of player comparisons for yourself or even look into differences in team stats as that data is also available on [Basketball Reference](https://www.basketball-reference.com/leagues/NBA_2026_advanced.html). 
